package cz.eman.kaalsample.presentation.feature.popularmovies.adapter
 ...
 */
class PopularMoviesAdapter(private val imageLoader: ImageLoader,
                           private val onMovieCallback: (Movie) -> Unit) : RecyclerView.Adapter<PopularMoviesAdapter.PopMoviesViewHolder>() {
